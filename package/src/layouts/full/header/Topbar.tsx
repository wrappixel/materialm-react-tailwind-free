...
const Topbar = () => {
    ...
    return (
        <div className="py-[15px] px-6 z-40 sticky top-0 bg-[linear-gradient(90deg,#0f0533_0%,#1b0a5c_100%)]">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
                <div className="md:flex hidden items-center gap-5">
                    <Link target="_black" to="https://wrappixel.com">
                    ...
                    <div className="xl:flex items-center gap-4 pl-5 border-l border-opacity-20 border-white hidden">
                        <Link target="_black" to="https://wrappixel.com/templates/category/react-templates/" className="flex items-center gap-2 text-white bg-transparent hover:text-[#714bff]">
                        ...
                        <Link target="_black" to="https://wrappixel.com/hire-us/" className="flex items-center gap-2 text-white bg-transparent hover:text-[#714bff]">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 justify-center">
                    <h4 className="text-sm font-semibold text-white uppercase bg-[linear-gradient(90deg,#FFFFFF_0%,#8D70F8_100%)] [-webkit-background-clip:text] bg-clip-text [-webkit-text-fill-color:transparent]">Checkout Pro Version</h4>
                    <div className="flex flex-col sm:flex-row items-center gap-[10px]">
                        <div className="flex items-center gap-[10px]">
                            <div className="live-preview-drop rounded-sm! border border-[#ffffff66] hover:bg-[#8d70f8]">
                                <DropdownMenu>
                                    <DropdownMenuTrigger className="py-2 px-4 text-white focus:outline-hidden flex items-center gap-2">
                                        <p className="text-base text-white font-normal">Live Preview</p>
                                        <Icon icon="tabler:chevron-down" width={16} />
                                    </DropdownMenuTrigger>
                                    <DropdownMenuContent className="py-3 px-1 bg-white w-64" align="start">
                                        {
                                            dropdownItems.map((item) => {
                                                return (
                                                    <DropdownMenuItem key={item.id} className="p-0 focus:bg-transparent">
                                                        <Link to={item.href} target='_blank' className="flex items-center gap-3 text-base text-[#000c29] py-3 px-[18px] group rounded-sm hover:bg-[#000c290d] hover:text-[#000c29] focus:bg-[#000c290d] focus:text-[#000c29] w-full">
                                                            <img src={item.img} width={24} alt="logo" />
                            ...
                            <Link target="_black" to="https://wrappixel.com/templates/materialm-tailwind-react-admin-template/?ref=376" className="flex items-center px-4 py-[11px] rounded-sm gap-2 text-white bg-[#8d70f8] hover:bg-[#714bff]">
                                <Icon icon="solar:crown-linear" width={18} />
                                <h4 className="text-base font-normal leading-none text-white">Get Pro</h4>
                            </Link>
                        </div>
                        <Link target="_black" to="https://wrappixel.com/all-access-pass/?ref=376" className="flex items-center px-4 py-[11px] rounded-sm gap-2 text-black bg-[#b3f143] hover:bg-[#90de03]">
